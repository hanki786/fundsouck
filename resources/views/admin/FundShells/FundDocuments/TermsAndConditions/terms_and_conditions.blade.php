                        ...
                        <div class="card-body">
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tr>
                                    ...
                                    <th>Fund Name</th>
                                    <th>Propsectus</th>
                                    <th>Propsectus Date</th>
                                    <th>Action</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($terms_and_conditions as $row)
                                    <tr id="remote-fundkeyAttribute-{{ $row->id }}">
                                        ...
                                        <td>
                                            <a href="{{ route('termsAndConditions-delete', $row->id) }}"  class="btn btn-danger btn-sm"><i class="fa fa-remove"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
