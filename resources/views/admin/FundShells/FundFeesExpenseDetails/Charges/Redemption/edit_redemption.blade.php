                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        @endif
                                            ...
                                            <input type="text" value="{{ $redemption->actual }}" class="form-control" name="actual" placeholder="Enter Actual ">
                                        </div>


                                        <div class="form-group">
                                            <label for="min">Minimum</label>
                                            <input type="text" value="{{ $redemption->min }}" class="form-control" name="min" placeholder="Enter Minimum">
                                        </div>

                                        <div class="form-group">
                                            <label for="max">Maximum</label>
                                            <input type="text" value="{{ $redemption->max }}" class="form-control" name="max" placeholder="Enter Maximum">
                                        </div>

                                        <div class="form-group">
                                            <label for="amount">Amount</label>
                                            <input type="number" value="{{ $redemption->amount }}" class="form-control" name="amount" placeholder="Enter Amount">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" value="{{ $redemption->payment_deadline }}" class="form-control" name="payment_deadline"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $redemption->early_redemption_fees }}" class="form-control"
