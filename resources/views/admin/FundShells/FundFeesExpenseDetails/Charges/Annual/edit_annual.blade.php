...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a  href="{{ route('list-annual-on-admin-side') }}">Annual - List</a></li>
        <li class="breadcrumb-item active">Annual - Edit</li>
        <!-- Breadcrumb Menu-->
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form action="{{ route('update-annual-on-admin-side',$annual->id) }}" method="post">
                {!! csrf_field() !!}
                <div class="row">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="hidden" name="user_id" value="{{ $annual->user_id}}">

                                        <div class="form-group">
                                            <label for="actual">Actual</label>
                                            <input type="text" value="{{ $annual->actual}}"
