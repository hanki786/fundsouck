...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Initial - List</li>
        <!-- Breadcrumb Menu-->
        ...
        <div class="animated fadeIn">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <i class="fa fa-align-justify"></i> Initial Table
                        </div>
                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                @foreach($initial as $row)
                                    <tr id="remote-fundkeyAttribute-{{ $row->id }}">
                                        <td>{{ $row->id }}</td>
                                        <td>
                                            <a  href="{{ route('view-initial-on-admin-side', $row->id) }}"
                                        ...
                                        <td>{{ $row->type }}</td>
                                        <td>
                                            <a  href="{{ route('edit-initial-on-admin-side', $row->id) }}"
                                                class="btn btn-default btn-sm"><i class="fa fa-pencil "> Edit</i></a>

                                            <a href="{{ route('initial-delete', $row->id) }}"
