...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a  href="{{ route('list-initial-on-admin-side') }}">Initial - List</a></li>
        <li class="breadcrumb-item active">Initial - Edit</li>
        <!-- Breadcrumb Menu-->
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form action="{{ route('update-initial-on-admin-side',$initial->id) }}" method="post">
                {!! csrf_field() !!}
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Edit Initial</h4>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        @endif
                                            ...
                                            <input type="hidden" name="user_id" value="{{ $initial->user_id}}">

                                        <div class="form-group">
                                            <label for="actual">Actual</label>
                                            <input type="text" value="{{ $initial->actual}}"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" value="{{ $initial->amount}}"
