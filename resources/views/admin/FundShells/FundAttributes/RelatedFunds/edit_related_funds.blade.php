                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-input" name="vehicle_name" placeholder="Enter Vehicle Name" value="{{ $related_fund->vehicle_name}}">
                                        </div>


                                        <div class="form-group">
                                            <label for="umbrella_name">Umbrella Name</label>
                                            <input type="text" class="form-control border-input" name="umbrella_name" placeholder="Enter Umbrella Name" value="{{ $related_fund->umbrella_name}}">
                                        </div>
