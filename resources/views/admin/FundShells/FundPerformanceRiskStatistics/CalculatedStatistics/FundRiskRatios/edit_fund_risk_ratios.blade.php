            ...
            <form action="{{ route('update-fundRiskRatios-on-admin-side',$fund_risk_ratio->id) }}" method="post">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Edit Fund Risk Ratio</h4>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        @endif
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->bear_beta }}"
                                                   class="form-control border-input" name="bear_beta"  placeholder="0.0048">
                                        </div>

                                        <div class="form-group">
                                            <label for="beta">Beta</label>
                                            <input type="text" value="{{ $fund_risk_ratio->beta }}"
                                                   class="form-control border-input" name="beta" placeholder="0.072">
                                        </div>

                                        <div class="form-group">
                                            <label for="bull_beta">Bull Beta</label>
                                            <input type="text" value="{{ $fund_risk_ratio->bull_beta }}"
                                                   class="form-control border-input" name="bull_beta" placeholder="0.19">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->alpha }}"
                                                   class="form-control border-input" name="alpha" placeholder="0.054">
                                        </div>

                                        <div class="form-group">
                                            <label for="kurtosis">Kurtosis</label>
                                            <input type="text" value="{{ $fund_risk_ratio->kurtosis }}"
                                                   class="form-control border-input" name="kurtosis" placeholder="0.030">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->maximum_drawdown }}"
                                                   class="form-control border-input" name="maximum_drawdown" placeholder="1.25">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->maximum_drawdown_period }}"
                                                   class="form-control border-input" name="maximum_drawdown_period" placeholder="2.05">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->maximum_gain }}"
                                                   class="form-control border-input" name="maximum_gain" placeholder="3.052">
                                        </div>

                                        <div class="form-group">
                                            <label for="maximum_loss">Maximum Loss</label>
                                            <input type="text" value="{{ $fund_risk_ratio->maximum_loss }}"
                                                   class="form-control border-input" name="maximum_loss" placeholder="0.027">
                                        </div>

                                        <div class="form-group">
                                            <label for="negative_periods">Negative Periods</label>
                                            <input type="text" value="{{ $fund_risk_ratio->negative_periods }}"
                                                   class="form-control border-input" name="negative_periods" placeholder="6.01">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->omega }}"
                                                   class="form-control border-input" name="omega" placeholder="3.26">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->positive_periods }}"
                                                   class="form-control border-input" name="positive_periods" placeholder="2.03">
                                        </div>
