                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->bear_beta }}"
                                                   class="form-control" name="bear_beta"  placeholder="0.0048" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label for="beta">Beta</label>
                                            <input type="text" value="{{ $fund_risk_ratio->beta }}"
                                                   class="form-control" name="beta" placeholder="0.072" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label for="bull_beta">Bull Beta</label>
                                            <input type="text" value="{{ $fund_risk_ratio->bull_beta }}"
                                                   class="form-control" name="bull_beta" placeholder="0.19" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->alpha }}"
                                                   class="form-control" name="alpha" placeholder="0.054" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label for="kurtosis">Kurtosis</label>
                                            <input type="text" value="{{ $fund_risk_ratio->kurtosis }}"
                                                   class="form-control" name="kurtosis" placeholder="0.030" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->maximum_drawdown }}"
                                                   class="form-control" name="maximum_drawdown" placeholder="1.25" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->maximum_drawdown_period }}"
                                                   class="form-control" name="maximum_drawdown_period" placeholder="2.05" disabled>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->omega }}"
                                                   class="form-control" name="omega" placeholder="3.26" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $fund_risk_ratio->positive_periods }}"
                                                   class="form-control" name="positive_periods" placeholder="2.03" disabled>
                                        </div>
