...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Sourced Statistics - Edit</li>
        <!-- Breadcrumb Menu-->
...
@section('content')
    ...
    <div class="container-fluid">
        <div class="animated fadeIn">
            <form action="{{ route('update-sourcedStatistics-on-admin-side',$sourced_statistics->id) }}" method="post">
                {!! csrf_field() !!}
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong>Edit Sourced Statistics</strong>
                                <small>Form</small>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        @endif
                                            ...
                                            <input type="hidden" name="fund_objective_id" value="{{ $sourced_statistics->id }}">

                                            <input type="hidden" name="user_id" value="{{ $sourced_statistics->user_id}}">


                                            <div class="form-group">
                                            <label for="sharpe_ratio">Sharpe Ratio</label>
                                            <input type="text" value="{{ $sourced_statistics->sharpe_ratio }}"
                                                   class="form-control" name="sharpe_ratio"  placeholder="0.48">
                                        </div>

                                        <div class="form-group">
                                            <label for="ytd_current_year">YTD Current Year</label>
                                            <input type="text" value="{{ $sourced_statistics->ytd_current_year }}"
                                                   class="form-control" name="ytd_current_year" placeholder="7.52">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $sourced_statistics->yield_since_inception }}"
                                                   class="form-control" name="yield_since_inception" placeholder="2.19">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $sourced_statistics->ytd_standard_deviation }}"
                                                   class="form-control" name="ytd_standard_deviation" placeholder="0.007">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $sourced_statistics->standard_deviation_for_3_years }}"
                                                   class="form-control" name="standard_deviation_for_3_years" placeholder="10">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $sourced_statistics->standard_deviation_for_5_years }}"
                                                   class="form-control" name="standard_deviation_for_5_years" placeholder="5">
                                        </div>
