                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong>Sourced Statistics</strong>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $sourced_statistics->sharpe_ratio }}"
                                                   class="form-control" name="sharpe_ratio"  placeholder="0.48" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label for="ytd_current_year">YTD Current Year</label>
                                            <input type="text" value="{{ $sourced_statistics->ytd_current_year }}"
                                                   class="form-control" name="ytd_current_year" placeholder="7.52" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $sourced_statistics->yield_since_inception }}"
                                                   class="form-control" name="yield_since_inception" placeholder="2.19" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $sourced_statistics->ytd_standard_deviation }}"
                                                   class="form-control" name="ytd_standard_deviation" placeholder="0.007" disabled>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $sourced_statistics->standard_deviation_for_3_years }}"
                                                   class="form-control" name="standard_deviation_for_3_years" placeholder="10" disabled>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $sourced_statistics->standard_deviation_for_5_years }}"
                                                   class="form-control" name="standard_deviation_for_5_years" placeholder="5" disabled>
                                        </div>
