                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong>Edit Index Time Series</strong>
                                <small>Form</small>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        @endif
                                            ...
                                            <input type="text" value="{{ $index_time_series->index_price}}" class="form-control" name="index_price" placeholder="Enter Index Price ">
                                        </div>


                                        <div class="form-group">
                                            <label for="index_price_date">Index Price Date</label>
                                            <input type="date" value="{{ $index_time_series->index_price_date }}" class="form-control" name="index_price_date">
                                        </div>

                                        <div class="form-group">
                                            <label for="index_net_return">Index Net Return</label>
                                            <input type="text" value="{{ $index_time_series->index_net_return }}" class="form-control" name="index_net_return" placeholder="Enter Index Net Return">
                                        </div>

                                        <div class="form-group">
                                            <label for="index_gross_return">Index Gross Return</label>
                                            <input type="text" value="{{ $index_time_series->index_gross_return }}" class="form-control" name="index_gross_return" placeholder="Enter Index Gross Return">
                                        </div>
